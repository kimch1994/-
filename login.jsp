    ...
    <div class="wrapper">
        <div class="main">
            ...
            <div class="login_box">
             ...
             <form method="post"  action="login_check.jsp"  name="LogIn" onsubmit="return LOGIN()">
                ...
                <div class="last">
                    <div class="join"><a href="member.jsp" style="text-decoration: none;">회원가입</a></div>
                    <div class="search"><a href="search.jsp" style="text-decoration: none;">비밀번호 찾기</a></div>
                </div>
            </div>
        </div>
    </div>
