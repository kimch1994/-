...
<body>
		...
		<span class="right"style="padding: 10px 30px;">
			<ul>
				<li style="float:left; list-style-type : none; margin:5px 10px 10px 100px; font-family:Nanum Brush Script; font-size:25px;"> <a><%=e1 %> 님 반갑습니다.</a></li>
				 ...
				 <a href="list.jsp" targrt="_self" style="margin:0px 0px 0px 170px; font-family:Nanum Brush Script; font-size:25px;">자유게시판</a>
	...
	<article>
		<h2 style="margin:10px 0px 10px 600px ; font: bold 1.6em 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #fff; font-size: 35px; text-align:center;">지역별 게스트 하우스</h2> 
			<div class="main"> 
				<div class="seoul">
				<a href="seoul_after.jsp" target="_self"><img src="./image/seoul.jpg" style="border-radius:15px;"> </a>
				...
				<div class="Busan">
				<a href="busan_after.jsp" target="_self"><img src="./image/busan.jpg" style="border-radius:15px;"> </a>
				...
				<div class="incheon">
				<a href="incheon_after.jsp" target="_self"><img src="./image/incheon.jpg" style="border-radius:15px;"> </a>
				...
				<div class="Jeju"> 
				<a href="jeju_after.jsp" target="_self"><img src="./image/jeju.jpg" style="border-radius:15px;"> </a>
				...
				<div class="Gyeongju"> 
				<a href="Gyeongju_after.jsp" target="_self"><img src="./image/Gyeongju.jpg" style="border-radius:15px;"> </a>
				...
				<div class="Daegu"> 
				<a href="daegu_after.jsp" target="_self"><img src="./image/Daegu.jpg" style="border-radius:15px;"> </a>
				...
				<div class="Daejeon">
				<a href="chun_after.jsp" target="_self"><img src="./image/chun.jpg" style="border-radius:15px;"> </a>
				...
				<div class="Yeosu">
				<a href="yeosu_after.jsp" target="_self"><img src="./image/yeosu.jpg" style="border-radius:15px;"> </a>
			...
			<h2 style="margin:-55px 0px 10px 80px; font: bold 1.3em 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #fff; font-size: 35px">지금 인기있는 게스트하우스</h2>
			<div class="lating">
			<%
		Connection con = null;
