...
<body>
	<header>
		...
		<span class="right"style="padding: 10px 30px;">
			<ul>
				<li style="float:left; list-style-type : none; margin:10px 10px 10px 10px"> <a href="login.jsp" targrt="_self">로그인</a></li>
				<li style="float:left; list-style-type : none; margin:10px 10px 10px 10px" > <a href="member.jsp" target="_self">회원가입</a></li>
			</ul>
