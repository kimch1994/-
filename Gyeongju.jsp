...
<body>
	<header>
		...
		<span class="right"style="padding: 10px 30px;">
			<ul>
				<li style="float:left; list-style-type : none; margin:10px 10px 10px 10px"> <a href="login.jsp" targrt="_self" style="font-family:Nanum Brush Script; font-size:25px;">로그인</a></li>
				<li style="float:left; list-style-type : none; margin:10px 10px 10px 10px" > <a href="member.jsp" target="_self" style="font-family:Nanum Brush Script; font-size:25px;">회원가입</a></li>
			</ul>
			<!-- <a style="margin: 10px 10px 10px -780px; font-size:50px;"> 어디 봐? 한눈에 보자!</a> -->
    	</span>
    	</div>
    </header>
    <article>
